...
public class PagerSlidingTab extends HorizontalScrollView { 
	...
	private int indicatorColor = 0xFFFF5000 ;//#0084FF
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				tab.setTextColor(i==0?getResources().getColor(com.hyp.life.R.color.slidingtab_indicatorcolor):tabTextColor);
